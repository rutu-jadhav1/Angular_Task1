...
@Component({
  selector: 'app-root',
  imports: [RouterOutlet,VariableComponent, ObjectComponent,ArrayComponent, FunctionComponent, UserProfileComponent, ImageComponent, ClickButtonComponent, TwoWayBindingComponent],
